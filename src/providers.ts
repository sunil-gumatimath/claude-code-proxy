...
const CAPABILITIES: Record<string, ModelCapabilities> = {
  ...
  "kilo/nvidia/nemotron-3-ultra-550b-a55b:free": { tools: true, vision: false, free: true }, // 1M
  "kilo/nvidia/nemotron-3.5-lightning:free": { tools: true, vision: false, free: true }, // 1M
  "kilo/nvidia/nemotron-3-super-120b-a12b:free": { tools: true, vision: false, free: true }, // 262K
  "kilo/nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free": { tools: true, vision: true, free: true }, // 256K, omni
  ...
  "kilo/inclusionai/ling-3.0-flash-sante:free": { tools: true, vision: false, free: true }, // 262K
...
export function canonicalizeModelId(value: string): string {
  ...
  return model.toLowerCase().startsWith(`${canonical}/`) ? value : `${canonical}/${model}`;
}
...
export function getCapabilities(target: UpstreamTarget): ModelCapabilities {
  ...
  return CAPABILITIES[displayTarget(target)] ?? { tools: false, vision: false, free: false };
}
